classdef StopWords
    ...
    methods(Static)
        ...
        function stop_word_library = stop_words()
              
            
            stop_word_library.words = ["a's", "able", "about", "above", "according", "accordingly", "across", "actually", "after", "afterwards",...
                ...
                "aren't", "around", "as", "aside", "ask", "asking", "associated", "at", "available", "away", "awfully", "be", "became",...
                "because", "become", "becomes", "becoming", "been", "before", "beforehand", "behind", "being", "believe",...
                "below", "beside", "besides", "best", "better", "between", "beyond", "both", "brief", "but", "by", "c'mon",...
                ...
                "her", "here", "here's", "hereafter", "hereby", "herein", "hereupon", "hers", "herself", "hi", "him", "himself",...
                ...
                "just", "keep", "keeps", "kept", "know", "knows", "known", "last", "lately", "later", "latter", "latterly", "least", "less",...
                "lest", "let", "let's", "like", "liked", "likely", "little", "look", "looking", "looks", "ltd", "mainly", "many", "may",...
                ...
                "obviously", "of", "off", "often", "oh", "ok", "okay", "old", "on", "once", "one", "ones", "only", "onto", "or",...
                ...
                "seven", "several", "shall", "she", "should", "shouldn't", "since", "six", "so", "some", "somebody", "somehow",...
                "someone", "something", "sometime", "sometimes", "somewhat", "somewhere", "soon", "sorry", "specified", "specify",...
                "specifying", "still", "sub", "such", "sup", "sure", "t's", "take", "taken", "tell", "tends", "th", "than",...
                "thank", "thanks", "thanx", "that", "that's", "thats", "the", "their", "theirs", "them", "themselves", "then",...
                ...
                "various", "very", "via", "viz", "vs", "want", "wants", "was", "wasn't", "way", "we", "we'd", "we'll", "we're",...
                "we've", "welcome", "well", "went", "were", "weren't", "what", "what's", "whatever", "when", "whence", "whenever",...
                ...
                "within", "without", "won't", "wonder", "would", "would", "wouldn't", "yes", "yet", "you", "you'd", "you'll",...
                "you're", "you've", "your", "yours", "yourself", "yourselves", "zeros", "able", "about", "above", "according",...
                "accordingly", "across", "actually", "after", "afterwards", "again", "against", "ainstopwordst", "all", "allow",...
                "allows", "almost", "alone", "along", "already", "also", "although", "always", "am", "among", "amongst", "an",...
                "and", "another", "any", "anybody", "anyhow", "anyone", "anything", "anyway", "anyways", "anywhere", "apart",...
                "appear", "appreciate", "appropriate", "are", "aren t", "around", "as", "aside", "ask", "asking", "associated",...
                ...
                "course", "currently", "definitely", "described", "despite", "did", "didn.t", "different",...
                ...
                "right", "said", "same", "saw", "say", "saying", "says", "second", "secondly",...
                ...
                "specify", "specifying", "still", "sub", "such", "sup", "sure", "t2s", "take", "taken",...
                "tell", "tends", "th", "than", "thank", "thanks", "thanx", "that", "that.s", "thats",...
                "the", "their", "theirs", "them", "themselves", "then", "thence", "there", "there.s",...
                "thereafter", "thereby", "therefore", "therein", "theres", "thereupon", "these",...
                "they", "they.d", "they ll", "they2re", "they.ve", "think", "third", "this",...
                ...
                "viz", "vs", "want", "wants", "was", "wasn.t", "way", "we", "we.d",...
                ...
                "wherever", "whether", "which", "while", "whither", "who", "who2s", "whoever",...
